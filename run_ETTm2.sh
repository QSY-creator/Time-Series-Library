...
"./scripts/long_term_forecast/ETT_script/iTransFormer_ETTm2.sh"
"./scripts/long_term_forecast/ETT_script/Pyraformer_ETTm2.sh"
"./scripts/long_term_forecast/ETT_script/LightTS_ETTm2.sh"
"./scripts/long_term_forecast/ETT_script/TimeMixer_ETTm2.sh"
"./scripts/long_term_forecast/ETT_script/SSSS_ETTm2.sh"
)
