...
SCRIPTS=(
  ...
  "./scripts/long_term_forecast_noise/ETT_script/Autoformer_ETTh1_drift.sh"
  "./scripts/long_term_forecast_noise/ETT_script/Autoformer_ETTh1_dropout.sh"
  "./scripts/long_term_forecast_noise/ETT_script/DLinear_ETTh1_dropout.sh"
  "./scripts/long_term_forecast_noise/ETT_script/DLinear_ETTh1_drift.sh"
  "./scripts/long_term_forecast_noise/ETT_script/DLinear_ETTh1_gaussian.sh"
  ...
  "./scripts/long_term_forecast_noise/ETT_script/TimeMixer_ETTh1_gaussian.sh"
  "./scripts/long_term_forecast_noise/ETT_script/PatchTST_ETTh1_drift.sh"
  "./scripts/long_term_forecast_noise/ETT_script/PatchTST_ETTh1_dropout.sh"
  "./scripts/long_term_forecast_noise/ETT_script/PatchTST_ETTh1_gaussian.sh"
  "./scripts/long_term_forecast_noise/ETT_script/RobustTimeMixer_ETTh1_dropout.sh"
  "./scripts/long_term_forecast_noise/ETT_script/RobustTimeMixer_ETTh1_gaussian.sh"
