...
SCRIPTS=(
"./scripts/long_term_forecast/ETT_script/DLinear_ETTm1.sh"
...
"./scripts/long_term_forecast/ETT_script/iTransFormer_ETTm1.sh"
"./scripts/long_term_forecast/ETT_script/Pyraformer_ETTm1.sh"
"./scripts/long_term_forecast/ETT_script/LightTS_ETTm1.sh"
"./scripts/long_term_forecast/ETT_script/TimeMixer_ETTm1.sh"
"./scripts/long_term_forecast/ETT_script/SSSS_ETTm1.sh"
)
