...
SCRIPTS=(
"./scripts/long_term_forecast/ETT_script/DLinear_ETTh2.sh"
...
"./scripts/long_term_forecast/ETT_script/LightTS_ETTh2.sh"
"./scripts/long_term_forecast/ETT_script/TimeMixer_ETTh2.sh"
"./scripts/long_term_forecast/ETT_script/SSSS_ETTh2.sh"
)
